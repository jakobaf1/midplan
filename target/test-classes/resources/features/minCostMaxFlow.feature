Feature: minCostMaxFlow algorithm
    ...
    #  Will implement when I look into the algorithm again
    # Scenario: when flow algorithm is finished, there are no more augmenting paths
    #     Given the shifts
    #         | shiftName | startTime | endTime |
    #         | Shift 1   | 07        | 15      |
    #         | Shift 2   | 07        | 19      |
    ...
    #     When the graph for a scheduling period of 8 weeks is created
    #     And solved using minCostMaxFlow algorithm
    #     Then there are no more augmenting paths